...
from .models import Teep, Profile
...
class ProfilePicForm(forms.ModelForm):
    ...
    class Meta:
        model = Profile
        fields = ('profile_image', 'profile_bio', 'instagram_link', 'facebook_link', 'linkedin_link', )

class TeepForm(forms.ModelForm):
    body= forms.CharField(required=True,
        widget = forms.Textarea(
            attrs={
                "placeholder": "Enter your Teeter Teep!",
                "class": "form-control",
            }
        ),
        label='',
